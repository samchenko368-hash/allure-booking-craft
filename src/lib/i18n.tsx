...
export const dict: Dict = {
  ...
  "admin.f.role": { pl: "Specjalizacja", en: "Role", uk: "Спеціалізація", ru: "Специализация" },
  "admin.f.bio": { pl: "Krótki opis", en: "Short bio", uk: "Короткий опис", ru: "Краткое описание" },
  "admin.f.photo": { pl: "Zdjęcie", en: "Photo", uk: "Фото", ru: "Фото" },
  "admin.staff": { pl: "Nasi mistrzowie", en: "Our masters", uk: "Наші майстри", ru: "Наши мастера" },
  "admin.staff.subtitle": {
    pl: "Dodawaj zdjęcia, imiona i krótkie opisy specjalistów.",
    en: "Add photos, names and short bios of your specialists.",
    uk: "Додавайте фото, імена та короткі описи майстрів.",
    ru: "Добавляйте фото, имена и краткие описания мастеров.",
  },
  "admin.staff.add": { pl: "Dodaj mistrza", en: "Add master", uk: "Додати майстра", ru: "Добавить мастера" },
  "team.heading": { pl: "Nasi mistrzowie", en: "Our masters", uk: "Наші майстри", ru: "Наши мастера" },
  "team.subheading": {
    pl: "Zespół, który zadba o Twoje piękno.",
    en: "The team that takes care of your beauty.",
    uk: "Команда, яка подбає про вашу красу.",
    ru: "Команда, которая позаботится о вашей красоте.",
  },
  "nav.team": { pl: "Mistrzowie", en: "Masters", uk: "Майстри", ru: "Мастера" },
